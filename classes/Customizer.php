...
class E360VO_Customizer
{
    ...
    public function __construct()
    {
        ...
        // Encolar hojas de estilo (front)
       // add_action('wp_enqueue_scripts', [$this, 'enqueue_color_scheme_styles'], 5);
    ...
    public function add_color_scheme_class($classes)
    {
        ...
        // Siguiendo tu idea BEM, podría ser: esquema--azul, theme--light, header--oscuro
        // o mantienes tu estilo actual: esquema-azul, header-oscuro, etc.
    ...
    /**
     * Encolar la hoja de estilo según tema y color
     */
