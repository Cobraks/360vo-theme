...
class E360VO_ColorPalette
{
    ...
    protected static $palettes = [
        ...
        'verde' => [
            '--primary0'              => 'hsla(0,0%,0%,1)',
            '--primary5'              => 'hsla(135,100%,10.4%,1)',
            '--primary10'             => 'hsla(132,100%,14.9%,1)',
            '--primary15'             => 'hsla(130,100%,19.2%,1)',
            '--primary20'             => 'hsla(130,100%,23.7%,1)',
            '--primary25'             => 'hsla(130,90.5%,29%,1)',
            '--primary30'             => 'hsla(133,69.1%,35.5%,1)',
            '--primary35'             => 'hsla(133,58.7%,40.8%,1)',
            '--primary40'             => 'hsla(134,51.5%,46.1%,1)',
            '--primary50'             => 'hsla(135,54.8%,56.7%,1)',
            '--primary60'             => 'hsla(135,73.7%,67.3%,1)',
            '--primary70'             => 'hsla(135,100%,77.5%,1)',
            '--primary80'             => 'hsla(136,100%,85.3%,1)',
            '--primary90'             => 'hsla(140,100%,92.9%,1)',
            '--primary95'             => 'hsla(146,100%,96.9%,1)',
            '--primary99'             => 'hsla(195,100%,99.2%,1)',
            '--primary100'            => 'hsla(0,0%,100%,1)',

            '--secondary0'            => 'hsla(0,0%,0%,1)',
            '--secondary5'            => 'hsla(136,50%,8.6%,1)',
            '--secondary10'           => 'hsla(136,33.3%,12.9%,1)',
            '--secondary15'           => 'hsla(137,26.4%,17.1%,1)',
            '--secondary20'           => 'hsla(137,21.1%,21.4%,1)',
            '--secondary25'           => 'hsla(137,17.6%,25.7%,1)',
            '--secondary30'           => 'hsla(137,15.6%,30.2%,1)',
            '--secondary35'           => 'hsla(137,13.5%,34.9%,1)',
            '--secondary40'           => 'hsla(138,12.3%,39.8%,1)',
            '--secondary50'           => 'hsla(138,10.3%,49.4%,1)',
            '--secondary60'           => 'hsla(138,12.6%,59.6%,1)',
            '--secondary70'           => 'hsla(141,17.9%,70.4%,1)',
            '--secondary80'           => 'hsla(141,29.2%,81.2%,1)',
            '--secondary90'           => 'hsla(141,70%,92.2%,1)',
            '--secondary95'           => 'hsla(146,100%,96.9%,1)',
            '--secondary98'           => 'hsla(167,100%,98.6%,1)',
            '--secondary99'           => 'hsla(195,100%,99.2%,1)',
            '--secondary100'          => 'hsla(0,0%,100%,1)',

            '--tertiary0'             => 'hsla(0,0%,0%,1)',
            '--tertiary5'             => 'hsla(210,63.2%,7.5%,1)',
            '--tertiary10'            => 'hsla(212,41%,12%,1)',
            '--tertiary15'            => 'hsla(214,32.5%,16.3%,1)',
            '--tertiary20'            => 'hsla(214,25.7%,20.6%,1)',
            '--tertiary25'            => 'hsla(214,21.9%,25.1%,1)',
            '--tertiary30'            => 'hsla(216,19.7%,29.8%,1)',
            '--tertiary35'            => 'hsla(216,17.7%,34.3%,1)',
            '--tertiary40'            => 'hsla(218,16%,39.2%,1)',
            '--tertiary50'            => 'hsla(217,13.6%,49%,1)',
            '--tertiary60'            => 'hsla(219,16.9%,59.4%,1)',
            '--tertiary70'            => 'hsla(220,24.2%,70%,1)',
            '--tertiary80'            => 'hsla(221,40.2%,81%,1)',
            '--tertiary90'            => 'hsla(222,100%,92%,1)',
            '--tertiary95'            => 'hsla(228,100%,96.1%,1)',
            '--tertiary98'            => 'hsla(248,100%,98.4%,1)',
            '--tertiary99'            => 'hsla(210,100%,99.2%,1)',
            '--tertiary100'           => 'hsla(0,0%,100%,1)',
            ...
            '--key-colors--primary'   => 'hsla(134,51.5%,46.1%,1)',
            '--key-colors--secondary' => 'hsla(138,12.3%,39.8%,1)',
            '--key-colors--tertiary'  => 'hsla(218,16%,39.2%,1)',
            '--key-colors--error'     => 'hsla(0,75.5%,41.6%,1)',
            '--key-colors--neutral'   => 'hsla(240,2.1%,37.6%,1)',
            '--key-colors--neutral-variant' => 'hsla(234,5.1%,38.4%,1)',
            ...
            '--surface1'              => 'hsla(141,9%,15%,1)',
            '--surface2'              => 'hsla(138,11%,17%,1)',
            '--surface3'              => 'hsla(140,12%,20%,1)',
            '--surface4'              => 'hsla(140,13%,21%,1)',
            '--surface5'              => 'hsla(138,14%,22%,1)',
        ],
        'morado' => [
            '--primary0'              => 'hsla(0,0%,0%,1)',
            '--primary5'              => 'hsla(285,100%,10.4%,1)',
            '--primary10'             => 'hsla(282,100%,14.9%,1)',
            '--primary15'             => 'hsla(280,100%,19.2%,1)',
            '--primary20'             => 'hsla(280,100%,23.7%,1)',
            '--primary25'             => 'hsla(280,90.5%,29%,1)',
            '--primary30'             => 'hsla(283,69.1%,35.5%,1)',
            '--primary35'             => 'hsla(283,58.7%,40.8%,1)',
            '--primary40'             => 'hsla(284,51.5%,46.1%,1)',
            '--primary50'             => 'hsla(285,54.8%,56.7%,1)',
            '--primary60'             => 'hsla(285,73.7%,67.3%,1)',
            '--primary70'             => 'hsla(285,100%,77.5%,1)',
            '--primary80'             => 'hsla(286,100%,85.3%,1)',
            '--primary90'             => 'hsla(290,100%,92.9%,1)',
            '--primary95'             => 'hsla(296,100%,96.9%,1)',
            '--primary99'             => 'hsla(345,100%,99.2%,1)',
            '--primary100'            => 'hsla(0,0%,100%,1)',

            '--secondary0'            => 'hsla(0,0%,0%,1)',
            '--secondary5'            => 'hsla(286,50%,8.6%,1)',
            '--secondary10'           => 'hsla(286,33.3%,12.9%,1)',
            '--secondary15'           => 'hsla(287,26.4%,17.1%,1)',
            '--secondary20'           => 'hsla(287,21.1%,21.4%,1)',
            '--secondary25'           => 'hsla(287,17.6%,25.7%,1)',
            '--secondary30'           => 'hsla(287,15.6%,30.2%,1)',
            '--secondary35'           => 'hsla(287,13.5%,34.9%,1)',
            '--secondary40'           => 'hsla(288,12.3%,39.8%,1)',
            '--secondary50'           => 'hsla(288,10.3%,49.4%,1)',
            '--secondary60'           => 'hsla(288,12.6%,59.6%,1)',
            '--secondary70'           => 'hsla(291,17.9%,70.4%,1)',
            '--secondary80'           => 'hsla(291,29.2%,81.2%,1)',
            '--secondary90'           => 'hsla(291,70%,92.2%,1)',
            '--secondary95'           => 'hsla(296,100%,96.9%,1)',
            '--secondary98'           => 'hsla(317,100%,98.6%,1)',
            '--secondary99'           => 'hsla(345,100%,99.2%,1)',
            '--secondary100'          => 'hsla(0,0%,100%,1)',

            '--tertiary0'             => 'hsla(0,0%,0%,1)',
            '--tertiary5'             => 'hsla(0,63.2%,7.5%,1)',
            '--tertiary10'            => 'hsla(2,41%,12%,1)',
            '--tertiary15'            => 'hsla(4,32.5%,16.3%,1)',
            '--tertiary20'            => 'hsla(4,25.7%,20.6%,1)',
            '--tertiary25'            => 'hsla(4,21.9%,25.1%,1)',
            '--tertiary30'            => 'hsla(6,19.7%,29.8%,1)',
            '--tertiary35'            => 'hsla(6,17.7%,34.3%,1)',
            '--tertiary40'            => 'hsla(8,16%,39.2%,1)',
            '--tertiary50'            => 'hsla(7,13.6%,49%,1)',
            '--tertiary60'            => 'hsla(9,16.9%,59.4%,1)',
            '--tertiary70'            => 'hsla(10,24.2%,70%,1)',
            '--tertiary80'            => 'hsla(11,40.2%,81%,1)',
            '--tertiary90'            => 'hsla(12,100%,92%,1)',
            '--tertiary95'            => 'hsla(18,100%,96.1%,1)',
            '--tertiary98'            => 'hsla(38,100%,98.4%,1)',
            '--tertiary99'            => 'hsla(0,100%,99.2%,1)',
            '--tertiary100'           => 'hsla(0,0%,100%,1)',
            ...
            '--key-colors--primary'   => 'hsla(284,51.5%,46.1%,1)',
            '--key-colors--secondary' => 'hsla(288,12.3%,39.8%,1)',
            '--key-colors--tertiary'  => 'hsla(8,16%,39.2%,1)',
            '--key-colors--error'     => 'hsla(0,75.5%,41.6%,1)',
            '--key-colors--neutral'   => 'hsla(240,2.1%,37.6%,1)',
            '--key-colors--neutral-variant' => 'hsla(234,5.1%,38.4%,1)',
            ...
            '--surface1'              => 'hsla(291,9%,15%,1)',
            '--surface2'              => 'hsla(288,11%,17%,1)',
            '--surface3'              => 'hsla(290,12%,20%,1)',
            '--surface4'              => 'hsla(290,13%,21%,1)',
            '--surface5'              => 'hsla(288,14%,22%,1)',
        ],
